...
<asp:Content ID="Content1" ContentPlaceHolderID="MyContentPlaceHolder" runat="server">
    ...
    <h1 align="center"><b>CREATE AN ACCOUNT</b></h1>
            ...
            <table align="center"> 
                <tr>
                    <td width="150px"></td>
                    <td align="right"><label for="inputENumber">E-Number:&nbsp;</label></td>
                    <td><asp:TextBox ID="cAinputENumber" runat="server"></asp:TextBox></td>
                    <td width="150px">
                ...
                <tr>
                    <td></td>
                    <td align="right"><label for="inputENumber">Password:&nbsp;</label></td>
                    <td><asp:TextBox ID="cAPassword" runat="server" TextMode="Password"></asp:TextBox></td>
                    <td><asp:RequiredFieldValidator ID="createPassword" runat="server" ControlToValidate="cAPassword" CssClass="error" Display="Dynamic" ErrorMessage="Password is required"></asp:RequiredFieldValidator></td>
                </tr>
                <tr>
                    <td></td>
                    ...
                    <td><asp:Label ID="valGradeLevel" runat="server" Text="Grade level required" CssClass="error"></asp:Label></td>
                </tr>
            </table>
            <br />
            <p align ="center">
